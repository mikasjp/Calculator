...
{
    public class ExternalLibraryCalculatorTests : CalculatorTestBase
    {
        [Theory]
        ...
        public async Task Calculate_Should_Succeed(string equation, decimal expected)
        {
            ...
            var loggerMock = CreateLoggerMock<ExternalLibraryCalculator>();
            ICalculator calculator = new ExternalLibraryCalculator(
                equationValidatorMock.Object, loggerMock.Object);
